...
![Saved Searches open in a collection view, showing searches grouped into a per-view section and a Whole collection section, each with rename and delete controls](Assets/saved-searches.png)
